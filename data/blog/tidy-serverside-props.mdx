...
summary: 'Using higher order functions to compose getServerSideProps to achieve cleaner and more organized code.'
image: '/static/images/tidy-serverside-props/bg.jpg'
languageTags: ['nextjs', 'typescript']
---

![Testing a React/Redux Toolkit app with Typescript](/static/images/tidy-serverside-props/bg.jpg)
