...
image: "/static/images/rust-like-error-handling-with-neverthrow/rust-bg.webp"
languageTags: ["javascript", "typescript", "nodejs"]
---

![Rusty rust](/static/images/rust-like-error-handling-with-neverthrow/rust-bg.webp)
