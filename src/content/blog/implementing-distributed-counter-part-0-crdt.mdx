...
Let's discuss the whats and whys of **CoW**(Copy-on-Write) [7], **CAS**(Compare and Swap) [6], Object Pooling and Ref Counting. I know we've discussed quite a bit of theory but, bear with me, we just need a bit more.
