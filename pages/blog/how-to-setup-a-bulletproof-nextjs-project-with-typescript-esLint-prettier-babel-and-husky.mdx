...
languageTags: ['typescript', 'tutorial', 'nextjs', 'react']
isPopular: false
guides: true
---
...
`prettier`. Now, all you have to do is enabling your ESLint. If you are using **vscode** simply download ESLint extension, and you are ready to go.
