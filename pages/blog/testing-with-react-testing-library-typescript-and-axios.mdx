...
image: '/static/images/testing-with-react-testing-library-typescript-and-axios/testing.png'
languageTags: ['typescript', 'tutorial', 'testing']
isPopular: false
guides: true
---

![react-testing-library](/static/images/testing-with-react-testing-library-typescript-and-axios/testing.png)

> “Always code as if the guy who ends up maintaining your code will be a violent psychopath who knows where you live.” (Martin Golding)

Source code of the project: [Github](https://github.com/ogzhanolguncu/react-testing-with-chuck)
...
Imagine a scenario where you develop a new component that works with your old component, you might be somehow modified your all components, so how do you make sure your old component is working as you expected?.
...
[Edit This Page](https://github.com/ogzhanolguncu/ogzhanolguncu.com/blob/master/pages/blog/testing-with-react-testing-library-typescript-and-axios.mdx)
