---
title: 'Speding Up Your Website'
publishedAt: '2021-01-31'
summary: "Techniques to speed your website, specifically React and NextJs. We'll discuss things like bundles, fonts, unicode-ranges, webpack."
...
![react-router](/static/images/build-a-custom-react-router-from-scratch/react-router.png)
...
Today, we to talk about techniques that I used to speed up this very own website. I was quite curious about what tricks people were using to optimize their
...
reducing bundle sizes, optimizing google fonts, using different bundles for development enviroment and production enviroment, tricks to utilize for custom fonts.
Finally here we're, on optimized website. Let's first see the _**GTmetrix**_ score.
