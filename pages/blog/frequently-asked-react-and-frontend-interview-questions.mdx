...
17. [Async vs Promise](#async-vs-promise)
    <!-- 18. [Value vs Reference](#value-vs-reference) -->
    <!-- 19. [Debounce and Throttle](#debounce-and-throttle) -->
...
These are actually pretty similar concepts, but difference lies in their syntaxes. `Async/Await` is basically syntactic sugar.
...
Pretty much same stuff, but `Async/Await` lets you write cleaner, maintainable and understandable functions.

Thanks for reading. (づ｡◕‿‿◕｡)づ

[Edit this page](https://github.com/ogzhanolguncu/ogzhanolguncu.com/blob/master/pages/blog/frequently-asked-react-and-frontend-interview-questions.mdx)
