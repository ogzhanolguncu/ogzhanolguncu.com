...
Long before **optional chaining** added to Ecmascript, we had to lots of hacky stuff to ensure data is not undefined. Things like this `person && person.car && person.car.wheels` if `person.car` is undefined and you have not used `&&` then you are screwed,
