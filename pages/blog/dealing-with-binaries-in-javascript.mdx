...
As you may have heard, binaries nothing but 1s and 0s streaming through your hardware. Logical example for binary would be, a _Light Bulb_.
...
In Javascript: 0b1110 >> 1 // Returns 57344
```
